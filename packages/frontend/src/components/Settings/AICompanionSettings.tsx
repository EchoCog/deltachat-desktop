...
interface APIKeyEntry {
  id: string
  name: string
  platform: 'claude' | 'chatgpt' | 'character-ai' | 'copilot' | 'deep-tree-echo' | 'custom'
  key: string
  lastUsed?: string
  endpoint?: string
}
    ...
    const updatedKeys = apiKeys.map(key => {
      if (key.id === editingId) {
        return {
          ...
          platform: newKey.platform as APIKeyEntry['platform'] || key.platform,
    ...
    <div className="ai-companion-settings">
      ...
      <div className="keys-container">
        ...
        {apiKeys.length === 0 ? (
          <div className="no-keys">
            ...
            <p className="hint">Add keys below to connect with AI companions.</p>
          </div>
        ) : (
            ...
            {apiKeys.map(key => (
              ...
              >
                <div className="key-info">
                  <div className="key-platform-icon" style={{ backgroundColor: getPlatformColor(key.platform) }}>
      ...
      <div className="add-key-section">
        <h2>
          ...
          <span>
            {isEditing 
              ? `Update API Key: ${apiKeys.find(k => k.id === editingId)?.name}`
              : 'Add New API Key'
            }
          </span>
        </h2>
        ...
        <div className="key-form">
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={e => setNewKey({...newKey, platform: e.target.value as APIKeyEntry['platform']})}
            >
          ...
          <div className="form-group">
            ...
            <div className="key-input-wrapper">
              ...
              >
                {showKey === 'new' ? <EyeOff size={16} /> : <Eye size={16} />}
              </button>
            </div>
          </div>
          
          {(newKey.platform === 'custom' || newKey.platform === 'deep-tree-echo') && (
            <div className="form-group">
      ...
      <div className="security-note">
        <Shield size={16} />
        <p>
          <strong>Security Note:</strong> Your API keys are stored locally and encrypted. 
