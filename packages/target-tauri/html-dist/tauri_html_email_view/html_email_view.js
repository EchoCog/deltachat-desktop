...
;(() => {
  ...
  function r(e, t, s, n) {
    ...
    return s === 'm' ? n : s === 'a' ? n.call(e) : n ? n.value : t.get(e)
  }
  a(r, '__classPrivateFieldGet')
      ...
      c.set(this, void 0),
        ...
        (this.id = k(s => {
          ...
          if (n == r(this, i, 'f')) {
            ...
            r(this, i, 'f') === r(this, m, 'f') && this.cleanupCallback()
          } else r(this, h, 'f')[n] = o
        }))
    }
    cleanupCallback() {
  ...
  let E = document.getElementById('subject'),
    ...
    v = document.getElementById('toggle_network_label'),
    g = document.getElementById('toggle_network_more_button'),
    w = !1
  d('get_html_window_info').then(
    ({
      subject: e,
      sender: t,
      receiveTime: s,
      toggleNetwork: n,
      networkButtonLabelText: o,
      blockedByProxy: _,
    }) => {
      _ && ((g.disabled = !0), (u.disabled = !0)),
        (E.innerText = e),
        (b.innerText = t),
        (v.innerText = o),
        (u.checked = w = n),
  ...
  g.onclick = e => {
    d('html_email_open_menu')
  }
  window.updateTheme = async () => {
    let e = await d('get_current_active_theme_address')
    e === 'system' &&
  ...
  window
    ...
    .addEventListener('change', e => {
      console.debug('system theme changed:', { dark_theme: e.matches }),
        window.updateTheme()
    })
  window.updateTheme()
})()
